...
public class ProductController implements ProductApi {
    ...
    @Override
    public ResponseEntity<List<Product>> getProductBatchById(BatchProductIdRequest batchProductIdRequest) throws Exception {
        return ok(service.getProducts(batchProductIdRequest));
    }
    ...
    @AdminOnly
    @Override
    public ResponseEntity<Product> addProduct(String userRole, ProductCreateRequest productCreateRequest) throws Exception {
        return status(HttpStatus.CREATED).body(service.createProduct(productCreateRequest));
    }

    @AdminOnly
    @Override
    public ResponseEntity<Product> updateProductById(String userRole, String productId, ProductUpdateRequest productUpdateRequest) throws Exception {
        return ok(service.updateProductById(productId, productUpdateRequest));
    }

    @AdminOnly
    @Override
    public ResponseEntity<Void> deleteProductById(String userRole, String id) throws Exception {
